...
class ChatAPI {
  ...
  Future sendMessage(String? conversationId, String? senderId, String? message) async {
    print(conversationId);
    print(senderId);
    print(message);
    var dio = Dio();
    var sendMessageURL = Config.apiURL + Config.sendMessage;
    try {
      var response = await dio.post(sendMessageURL,
          data: {"conversationId": conversationId, "sender": senderId, "text": message});
      return response.data;
    } catch (e) {
      rethrow;
    }
